...
namespace MeetingPlanner.Controllers
{
    public class PrayersController : Controller
    {
        ...
        public PrayersController(PlannerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PrayerID,OpeningP,SacramentP,ClosingP")] Prayer prayer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PrayerID,OpeningP,SacramentP,ClosingP")] Prayer prayer)
        {
